...
#define JOY_LEFT_X_PIN_DEFAULT    0
#define JOY_LEFT_Y_PIN_DEFAULT    1
#define JOY_LEFT_SW_PIN_DEFAULT   2

#define JOY_RIGHT_X_PIN_DEFAULT   3
#define JOY_RIGHT_Y_PIN_DEFAULT   4
