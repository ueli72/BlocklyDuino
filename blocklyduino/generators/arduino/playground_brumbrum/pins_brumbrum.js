/**
 * Pin Data for Playground BrumBrum (playground-brumbrum-esp32-s3-devkitc1)
 * 
...
var BOARD_NAME = 'Playground BrumBrum (esp32-s3-devkitc1)';
...
if (typeof window !== 'undefined') {
  window.PIN_DATA_BRUMBRUM = PIN_DATA;
  window.getBrumbrumPinInfo = getPinInfo;
  window.getBrumbrumPinTooltip = getPinTooltip;
  window.getBrumbrumPinsWithCapability = getPinsWithCapability;
  window.getBrumbrumAllPinOptions = getAllPinOptions;
  window.getBrumbrumDigitalPinOptions = getDigitalPinOptions;
  window.getBrumbrumPwmPinOptions = getPwmPinOptions;
  window.getBrumbrumAnalogPinOptions = getAnalogPinOptions;
  window.getBrumbrumInterruptPinOptions = getInterruptPinOptions;
}
