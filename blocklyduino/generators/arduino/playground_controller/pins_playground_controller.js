/**
 * Pin Data for Playground Controller (playground_controller)
 * 
 * This file contains pin definitions and capabilities for the Playground Controller board.
...
var BOARD_ID = 'playground_controller';
var BOARD_NAME = 'Playground Controller';
...
if (typeof window !== 'undefined') {
  window.PIN_DATA_PLAYGROUND_CONTROLLER = PIN_DATA;
  window.getPlaygroundControllerPinInfo = getPinInfo;
  window.getPlaygroundControllerPinTooltip = getPinTooltip;
  window.getPlaygroundControllerPinsWithCapability = getPinsWithCapability;
  window.getPlaygroundControllerAllPinOptions = getAllPinOptions;
  window.getPlaygroundControllerDigitalPinOptions = getDigitalPinOptions;
  window.getPlaygroundControllerPwmPinOptions = getPwmPinOptions;
  window.getPlaygroundControllerAnalogPinOptions = getAnalogPinOptions;
  window.getPlaygroundControllerInterruptPinOptions = getInterruptPinOptions;
}
