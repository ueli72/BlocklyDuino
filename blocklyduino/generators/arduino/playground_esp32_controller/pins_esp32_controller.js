...
var PIN_DATA = {
  ...
  "name": BOARD_NAME,
  "pins": {
    "0": {"name": "GPIO0", "capabilities": ["digital", "pwm", "interrupt", "adc"], "special": ["Joystick Left X"], "reserved": false, "notes": "Boot pin - hold LOW during boot for download mode"},
    "1": {"name": "GPIO1", "capabilities": ["digital", "pwm", "interrupt", "adc"], "special": ["Joystick Left Y"], "reserved": false, "notes": null},
