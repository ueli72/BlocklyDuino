/**
 * Pin Data for BWS Playground Master (playground_master)
 * 
 * This file contains pin definitions and capabilities for the Playground Master board.
 * It is used by common blocks to populate pin dropdowns and generate pin reference information.
 */

var BOARD_ID = 'playground_master';
var BOARD_NAME = 'BWS Playground Master';
...
if (typeof window !== 'undefined') {
  window.PIN_DATA_PLAYGROUND_MASTER = PIN_DATA;
  window.getPlaygroundMasterPinInfo = getPinInfo;
  window.getPlaygroundMasterPinTooltip = getPinTooltip;
  window.getPlaygroundMasterPinsWithCapability = getPinsWithCapability;
  window.getPlaygroundMasterAllPinOptions = getAllPinOptions;
  window.getPlaygroundMasterDigitalPinOptions = getDigitalPinOptions;
  window.getPlaygroundMasterPwmPinOptions = getPwmPinOptions;
  window.getPlaygroundMasterAnalogPinOptions = getAnalogPinOptions;
  window.getPlaygroundMasterInterruptPinOptions = getInterruptPinOptions;
}
