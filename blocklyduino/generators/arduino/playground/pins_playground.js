/**
 * Pin Data for BWS Playground Master (esp32-s3-devkitc1)
 * 
...
var BOARD_ID = 'esp32-s3-devkitc1';
...
if (typeof window !== 'undefined') {
  window.PIN_DATA_PLAYGROUND = PIN_DATA;
  window.getPlaygroundPinInfo = getPinInfo;
  window.getPlaygroundPinTooltip = getPinTooltip;
  window.getPlaygroundPinsWithCapability = getPinsWithCapability;
  window.getPlaygroundAllPinOptions = getAllPinOptions;
  window.getPlaygroundDigitalPinOptions = getDigitalPinOptions;
  window.getPlaygroundPwmPinOptions = getPwmPinOptions;
  window.getPlaygroundAnalogPinOptions = getAnalogPinOptions;
  window.getPlaygroundInterruptPinOptions = getInterruptPinOptions;
}
